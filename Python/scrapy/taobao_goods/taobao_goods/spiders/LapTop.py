...
class TapTop(scrapy.Spider):
    ...
    start_urls = [
        'https://list.tmall.com/search_product.htm?spm=a220m.1000858.0.0.aVNGHZ&cat=53320010&sort=d&style=g&active=1&industryCatId=53320010&theme=663&type=pc']
    ...
    def parse(self, response):
        ...
        for div in divs:
            ...
            try:
                item['IMG_URL'] = ['http:' + div.xpath(
                    'div/div[1]/a/img/@src | div/div[1]/a/img/@data-ks-lazyload').extract_first()]  # 这里必须是数组
